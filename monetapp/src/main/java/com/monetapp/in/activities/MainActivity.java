...
import com.monetapp.in.fragments.HomeFragment;
import com.monetapp.in.fragments.LoginFragment;
...
//        ab.setDisplayShowTitleEnabled(false); // disable the default title element here (for centered title)
        ...
        setUserProfile();
        setDrawerEnabled(MyApplication.isLoggedIn());
        setLogoutEnabled(MyApplication.isLoggedIn());
...
//            );
    ...
    public void setUserProfile() {
        ...
        tv_username.setText(MyApplication.getUserName());
        tv_email.setText(MyApplication.getEmailID());
    }
