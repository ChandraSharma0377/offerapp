...
import com.monetapp.in.beans.SpendIndividualCategoryBeans;
import com.monetapp.in.utility.Helper;

import java.util.ArrayList;


public class SpendIndividualCategoryAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<SpendIndividualCategoryBeans> arraylist;

    public SpendIndividualCategoryAdapter(Context context, ArrayList<SpendIndividualCategoryBeans> items) {
