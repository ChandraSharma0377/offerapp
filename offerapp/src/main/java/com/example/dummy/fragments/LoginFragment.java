...
import com.example.dummy.utility.ShowAlertInformation;
			...
			public void onClick(View v) {
				if (isValid()) {
					if (MainActivity.getNetworkHelper().isOnline()) {
						...
						MainActivity.getMainScreenActivity().setSharPreferancename("Guest User", edtEmail.getText().toString().trim(),
